...
await m.reply(`${who == m.sender ? `Tienes *${user.estrellas} 💵 Dolares* en tu Cartera` : `El usuario @${who.split('@')[0]} tiene *${user.estrellas} 💵 Dolares* en su Cartera`}. `, null, { mentions: [who] })}
